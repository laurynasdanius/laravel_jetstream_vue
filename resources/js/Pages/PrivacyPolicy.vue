    ...
    <div class="font-sans text-gray-900 antialiased">
        <div class="pt-4 bg-gray-100">
            <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
                ...
                <div class="w-full sm:max-w-2xl mt-6 p-6 bg-white shadow-md overflow-hidden sm:rounded-lg prose"> Notion Labs, Inc. (“Notion,” “we,” “us,” and “our”) provides an all-in-one workspace allowing our users to write, plan, collaborate, and get organized. Our Privacy Policy (“Privacy Policy”) is designed to help you understand how we collect, use and share your personal information and to assist you in exercising the privacy rights available to you.

## **Scope**

This Privacy Policy covers the personal information we collect about you when you use our products or services, or otherwise interact with us, including on our public website at [www.notion.so](http://www.notion.so/) (the "**Website**"), and Notion’s online software-as-service platform including any related APIs provided by Notion, together with all related mobile and desktop applications (collectively, “**Services**”). This policy also explains your choices surrounding how we use your personal information, which include how you can object to certain uses of the information and how you can access and update certain information.
...
- If you register a Notion account with an email address provisioned by your organization, Notion may share your name, Workspace ID, and email address with your organization. If you registered to use Notion’s Services with such an email address, but you do not use the Services in connection with your organization and you do not wish for this information to be shared with your organization, you may transfer your account to a different email address. For information on how to change the email address associated with your Notion account please follow the instructions here: [https://www.notion.so/help/account-settings](https://www.notion.so/help/account-settings). If you would like additional assistance, please contact [team@makenotion.com](mailto:team@makenotion.com).
...
- [Amplitude](http://amplitude.com/) (USA)
- [Segment](http://segment.com/) (USA)
- [Firebase](https://firebase.google.com/) (USA)
- [Intercom](https://www.intercom.io/) (USA)
- [Loggly](http://loggly.com/) (USA)
- [Snowflake](https://www.snowflake.com/) (USA)
- [Fivetran](https://fivetran.com/) (USA)
- [Stripe](http://stripe.com) (USA)
- [Datadog](https://www.datadoghq.com/) (USA)
...
For more information, please see our [Cookie Notice](https://www.notion.so/Cookie-Notice-bc186044eed5488a8387a9e94b14e58c).
...
**“Do Not Track”:** Your browser may offer you a “Do Not Track” option, which allows you to signal to operators of websites and web applications and Service that you do not wish such operators to track certain of your online activities over time and/or across different websites. If your browser is set to “Do Not Track”, Notion will attempt to honor this functionality. However, our third party service providers may use their own cookies, pixel tags, web beacons or other storage technology to collect and store Log Data or information from elsewhere on the internet, and we do not have access to, nor control over, a third parties’ use of cookies or other tracking technologies.
...
Notion Labs, Inc.
2300 Harrison Street Floor 2
San Francisco, CA 94110
United States
[team@makenotion.com](mailto:team@makenotion.com)

We have updated our Privacy Policy. If You are a new User, then this Privacy Policy will be effective as of January 28, 2022. If You are an existing User, we are providing you with prior notice of these changes which will be effective as of February 27, 2022.

Last updated: January 28, 2022

---

To view the previous version of Notion’s Privacy Policy, click the link below.

[Privacy Policy (Deprecated January 28, 2022)](https://www.notion.so/Privacy-Policy-Deprecated-January-28-2022-01ecb6309b5e4fbaac6fa5d9f78f6135)</div>
            </div>
        </div>
    </div>
</template>
