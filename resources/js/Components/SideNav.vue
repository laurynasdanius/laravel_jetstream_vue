...
<template>
    <aside class="w-auto" aria-label="Sidebar">
        <div class="overflow-y-auto px-auto bg-gray-50 rounded dark:bg-gray-800">
            <ul class="space-y-2">
                <li>
                <!--<li>
                <Link href="/">Home</Link>
                ...
                <li>
                    <button type="button"
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">Workspaces</span>
